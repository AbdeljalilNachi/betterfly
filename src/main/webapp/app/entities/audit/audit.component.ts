...
export class AuditComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.auditService
        ...
        .subscribe(
          (res: HttpResponse<IAudit[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInAudits(): void {
    this.eventSubscriber = this.eventManager.subscribe('auditListModification', () => this.loadPage());
  }
