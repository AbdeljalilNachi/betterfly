...
export class ObjectifComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.objectifService
        ...
        .subscribe(
          (res: HttpResponse<IObjectif[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInObjectifs(): void {
    this.eventSubscriber = this.eventManager.subscribe('objectifListModification', () => this.loadPage());
  }
