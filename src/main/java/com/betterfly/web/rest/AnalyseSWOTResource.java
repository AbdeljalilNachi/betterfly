...
public class AnalyseSWOTResource {
    ...
    public ResponseEntity<AnalyseSWOT> createAnalyseSWOT(@RequestBody AnalyseSWOT analyseSWOT) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/analyse-swots/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /analyse-swots} : Updates an existing analyseSWOT.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/analyse-swots")
    public ResponseEntity<AnalyseSWOT> updateAnalyseSWOT(@RequestBody AnalyseSWOT analyseSWOT) throws URISyntaxException {
        log.debug("REST request to update AnalyseSWOT : {}", analyseSWOT);
        if (analyseSWOT.getId() == null) {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, analyseSWOT.getId().toString()))
            .body(result);
    }
