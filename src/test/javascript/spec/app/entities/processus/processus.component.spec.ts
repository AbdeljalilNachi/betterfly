...
import { ProcessusComponent } from 'app/entities/processus/processus.component';
...
describe('Component Tests', () => {
  describe('Processus Management Component', () => {
    let comp: ProcessusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProcessusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.processuses && comp.processuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
