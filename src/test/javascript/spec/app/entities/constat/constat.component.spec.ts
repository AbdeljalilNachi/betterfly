...
import { ConstatComponent } from 'app/entities/constat/constat.component';
import { ConstatService } from 'app/entities/constat/constat.service';
import { Constat } from 'app/shared/model/constat.model';

describe('Component Tests', () => {
  describe('Constat Management Component', () => {
    let comp: ConstatComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConstatComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.constats && comp.constats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
