...
import { AutreActionComponent } from 'app/entities/autre-action/autre-action.component';
...
describe('Component Tests', () => {
  describe('AutreAction Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.autreActions && comp.autreActions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
